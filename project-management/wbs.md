...
```
0. Plant Expansion and Resource Optimization
├── 1. Evaluation & Diagnosis
│   ├── 1.1 Technical inventory of existing equipment
│   ├── 1.2 Real-time electrical monitoring
│   ├── 1.3 Production flow analysis
│   ├── 1.4 Process time measurement
│   └── 1.5 Diagnosis report
├── 2. Design & Planning
│   ├── 2.1 CAD modeling (SolidWorks)
│   ├── 2.2 New machinery specification
│   ├── 2.3 Energy efficiency plan
│   ├── 2.4 Electrical system upgrade design
│   └── 2.5 Project execution plan
├── 3. Implementation & Installation
│   ├── 3.1 Machinery manufacturing
│   ├── 3.2 Plant area expansion
│   ├── 3.3 Equipment installation & commissioning
│   ├── 3.4 EMS implementation
│   └── 3.5 Electrical system modernization
└── 4. Training & Preventive Maintenance
    ├── 4.1 Operator training — new machinery
    ├── 4.2 EMS training
    ├── 4.3 Preventive maintenance program
    └── 4.4 Project closure report
```

---

## Phase 1 — Evaluation & Diagnosis
...
- Electric motors older than 5 years consuming ~55,000 kWh/month with poor power factor.
- Faulty wiring connections causing Joule losses.
- Machine failures averaging 7–8 per month causing significant downtime.
...
## Phase 3 — Implementation & Installation
...
**Intervention cutoff**: August 2021 — new machinery fully operational. Pre/Post analysis boundary.

---

## Phase 4 — Training & Preventive Maintenance
...
|---|---|
| 1 — Evaluation & Diagnosis | Equipment inventory, consumption profile, bottleneck map, diagnosis report |
| 2 — Design & Planning | SolidWorks models, machinery specs, energy plan, electrical design, execution plan |
| 3 — Implementation | New machinery (manufactured by INGEDAV), expanded plant, EMS live, electrical upgrade |
| 4 — Training & Maintenance | Trained operators, preventive maintenance program, project closure report |
